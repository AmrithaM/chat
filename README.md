...
5. Users' messages display the username, the message, and the timestamp in
`yyyy-mm-dd hh:mm` format.
6. Messages should appear in chronological order.
7. Users' own messages are highlighted with a light green background.
8. Users can "like" each others' messages by clicking on a "like" button that appears on the
message.
9. Users can receive messages by refreshing the full page using the browser's refresh
button.
(Continued...)
